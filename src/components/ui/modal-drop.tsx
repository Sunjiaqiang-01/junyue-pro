          ...
          >
            {title ? (
              ...
              >
                ...
                {showCloseButton && (
                  <div
                    className={cn("flex items-center gap-2", subtitle && "absolute top-6 right-6")}
                  >
                    {showEscText && (
                    ...
                    >
                      <X className="w-5 h-5 text-pure-white hover:text-primary-cyan transition-colors" />
                    </button>
                  </div>
                )}
              </div>
            ...
            <div className={cn(!disablePadding && (!title ? "p-6 pt-12" : "p-6"))}>{children}</div>
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
